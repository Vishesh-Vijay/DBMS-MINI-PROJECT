...
<header>
    ...
    <div class="text-4xl flex justify-center mt-9"> Organ Required</div>
    <div class="flex justify-center mt-16">
    <div class="w-full max-w-xs">
  <form class=" px-8 pt-6 pb-8 mb-4" action="./Userpage.php" method="post">
    <div class="mb-4">
      <label class="block text-gray-700 text-sm font-bold mb-2" for="patientid">
        Patient id
      </label>
      <input class=" border rounded w-full py-3 px-4 " id="patientid" type="text" name="patientid">
    </div>
    <div class="mb-6">
